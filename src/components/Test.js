...
const EnhancedLandingPage = () => {
  ...
  const testimonials = [
    {
      quote: 'The automation features have saved us countless hours in property management tasks, regarding complex as well as simple problems',
      author: 'Subodh Hanmannavar',
      role: 'Property Owner'
    },
    {
      quote: 'Excellent platform that has streamlined our entire operation. The owner-builder portal is good at operating a apartment.',
      author: 'Amar Akknoji',
      role: 'Building Owner'
    },
    {
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href='/home' className="text-gray-400 hover:text-white transition">Features</a></li>
                <li><a href='/home' className="text-gray-400 hover:text-white transition">Pricing</a></li>
                <li><a href='/home' className="text-gray-400 hover:text-white transition">Documentation</a></li>
              </ul>
            </div>
            <div>
              <h4 className="text-white font-semibold mb-4">Company</h4>
              <ul className="space-y-2">
                <li><a href='/home' className="text-gray-400 hover:text-white transition">About Us</a></li>
                <li><a href='/home' className="text-gray-400 hover:text-white transition">Careers</a></li>
                <li><a href='/home' className="text-gray-400 hover:text-white transition">Contact</a></li>
              </ul>
            </div>
            <div>
              <h4 className="text-white font-semibold mb-4">Legal</h4>
              <ul className="space-y-2">
                <li><a href='/home' className="text-gray-400 hover:text-white transition">Privacy Policy</a></li>
                <li><a href='/home' className="text-gray-400 hover:text-white transition">Terms of Service</a></li>
                <li><a href='/home' className="text-gray-400 hover:text-white transition">Cookie Policy</a></li>
              </ul>
            </div>
          </div>
